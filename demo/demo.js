      ...
      <>
        <MuiThemeProvider theme={theme}>
          <div onClick={() => {
            this.setState({
              ...this.state,
              data: [ { id: 1, name: 'A1', surname: 'B', isMarried: true, birthDate: new Date(1987, 1, 1), birthCity: 0, sex: 'Male', type: 'adult', insertDateTime: '1994-11-23T08:15:30-05:00', time: new Date(1900, 1, 1, 14, 23, 35) },
              { id: 2, name: 'A2', surname: 'B', isMarried: false, birthDate: new Date(1987, 1, 1), birthCity: 34, sex: 'Female', type: 'adult', insertDateTime: '1994-11-05T13:15:30Z', time: new Date(1900, 1, 1, 14, 23, 35), parentId: 1 },
              { id: 3, name: 'A3', surname: 'B', isMarried: true, birthDate: new Date(1987, 1, 1), birthCity: 34, sex: 'Female', type: 'child', insertDateTime: new Date(2018, 1, 1, 12, 23, 44), time: new Date(1900, 1, 1, 14, 23, 35), parentId: 1 }]
            })
          }}>FUCK IT</div>
                  ...
                  detailPanel={[
                    {
                      ...
                      handleIconClick: (data) => {
                        if (!this.state.openedRows.includes(data.tableData.id)) {
                          this.setState({
                            ...this.state,
                            openedRows: [...this.state.openedRows, data.tableData.id]
                          })
                        } else {
                          this.setState({
                            ...this.state,
                            openedRows: this.state.openedRows.filter(row => row !== data.tableData.id)
                          })
                        }
                      },
